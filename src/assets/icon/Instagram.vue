    ...
    >
        <g>
            <g xmlns="http://www.w3.org/2000/svg">
                ...
                />
                <path
                    d="m255.973 330.784c41.273 0 74.852-33.591 74.852-74.88s-33.578-74.88-74.852-74.88-74.852 33.591-74.852 74.88 33.578 74.88 74.852 74.88zm0-134.76c33.002 0 59.852 26.862 59.852 59.88s-26.85 59.88-59.852 59.88-59.852-26.862-59.852-59.88 26.85-59.88 59.852-59.88z"
                    fill="#ffffff"
                    data-original="#000000"
                    style=""
                    class=""
                />
                <path
                    d="m400.298 144.558c0-15.168-12.337-27.508-27.5-27.508s-27.499 12.34-27.499 27.508 12.336 27.508 27.499 27.508 27.5-12.34 27.5-27.508zm-39.999 0c0-6.897 5.607-12.508 12.499-12.508 6.893 0 12.5 5.611 12.5 12.508s-5.607 12.508-12.5 12.508c-6.892-.001-12.499-5.611-12.499-12.508z"
                    fill="#ffffff"
                    data-original="#000000"
                    style=""
                    class=""
                ...
                />
                <path
                    d="m368.444 477.057h99.94c4.143 0 7.5-3.358 7.5-7.5s-3.357-7.5-7.5-7.5h-99.94c-4.143 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5z"
                    fill="#ffffff"
                    data-original="#000000"
                    style=""
                    class=""
                />
                <path
                    d="m368.444 443.044h89.947c4.143 0 7.5-3.358 7.5-7.5s-3.357-7.5-7.5-7.5h-89.947c-4.143 0-7.5 3.358-7.5 7.5s3.358 7.5 7.5 7.5z"
                    fill="#ffffff"
                    data-original="#000000"
                    style=""
                    class=""
